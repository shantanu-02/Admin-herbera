...
import { ShoppingBag, Users, Package, Star, Gift, TrendingUp } from 'lucide-react';
        ...
        <Card className="w-full max-w-md shadow-2xl border-0">
          <CardHeader className="space-y-4 pb-8">
            ...
            <div className="text-center">
              <CardTitle className="text-3xl font-bold text-gray-900">Herbera Co.</CardTitle>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <h1 className="text-2xl font-bold text-gray-900">Herbera Admin</h1>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          <Card className="border-0 shadow-lg bg-gradient-to-r from-blue-500 to-blue-600 text-white">
            ...
            <CardContent>
              ...
              <p className="text-xs opacity-80 mt-1">Active products in catalog</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-lg bg-gradient-to-r from-red-500 to-pink-500 text-white">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium opacity-90">Pending Reviews</CardTitle>
              <Star className="h-5 w-5 opacity-80" />
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-bold">{stats?.pendingReviews || 0}</div>
              <p className="text-xs opacity-80 mt-1">Reviews awaiting approval</p>
            </CardContent>
          </Card>

          <Card className="border-0 shadow-lg bg-gradient-to-r from-teal-500 to-cyan-500 text-white">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium opacity-90">Active Coupons</CardTitle>
